...
*   **auto-generate** - Preenche o valor com um dos valores automaticamente gerados. Substitui o valor opções.

*   **now** - o valor atual da data no formato ano/mês/dia
*   **id** - gera um identificador
*   **title** - gera o título
