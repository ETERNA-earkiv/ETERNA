...
Gallringsscheman anger minimikraven för underhålls-, bevarande- eller gallringsåtgärder som ska vidtas på befintliga eller framtida förvaringsenheter i detta arkiv. En förvaringsenhet får endast gallras som en del av en gallringsprocess som styrs av det gallringsschema som tilldelats den enheten. Det är den förvaringsenhetens gallringsschema som bestämmer hur länge en post bevaras och hur den därefter gallras i slutet av dess bevarandeperiod.
...
Gallringsstopp är en order som stoppar den normala processen för gallring och som innebär att en förvaringsenhet inte kommer att gallras. När gallringsstoppet är associerat med en förvaringsenhet kommer gallring inte att ske så länge som gallringsstoppet är aktivt i systemet. När gallringsstoppet inaktiveras, kommer gallringsprocessen att fortsätta. 
