...
public class UserLoginPortal {
  ...
  private static final ClientLogger logger = new ClientLogger(UserLoginPortal.class.getName());
  private static final ClientMessages messages = GWT.create(ClientMessages.class);

  private static UserLoginPortal instance = null;
   ...
   * @return the instance
   */
  public static UserLoginPortal getInstance() {
    if (instance == null) {
      instance = new UserLoginPortal();
    }
    return instance;
  }
