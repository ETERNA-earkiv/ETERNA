...
public class FileToolbarActions extends AbstractActionable<IndexedFile> {
  ...
  public ActionableBundle<IndexedFile> createActionsBundle() {
    ...
    downloadGroup.addButton(messages.downloadButton(), FileAction.DOWNLOAD, ActionImpact.NONE, "btn-download",
      "fileDownloadButton");

    // PRESERVATION
    ActionableGroup<IndexedFile> preservationGroup = new ActionableGroup<>(messages.preservationTitle(), "btn-play");
    ...
    fileActionableBundle.addGroup(downloadGroup).addGroup(managementGroup).addGroup(preservationGroup);
