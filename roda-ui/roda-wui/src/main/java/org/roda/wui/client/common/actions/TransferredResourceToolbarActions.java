 ...
 */
public class TransferredResourceToolbarActions extends AbstractActionable<TransferredResource> {

  public static final TransferredResource NO_TRANSFERRED_RESOURCE = null;

  private static final TransferredResourceToolbarActions GENERAL_INSTANCE = new TransferredResourceToolbarActions(
  ...
  private TransferredResourceToolbarActions(TransferredResource parentTransferredResource) {
  ...
  public static TransferredResourceToolbarActions get(TransferredResource parentTransferredResource) {
    if (parentTransferredResource == NO_TRANSFERRED_RESOURCE) {
      return GENERAL_INSTANCE;
    } else {
      return new TransferredResourceToolbarActions(parentTransferredResource);
    }
  }
