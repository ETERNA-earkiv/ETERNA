...
public interface AIPRestService extends RODAEntityRestService<IndexedAIP> {
  ...
  @RequestMapping(path = "/{id}/representation/{representation-id}/metadata/descriptive", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseStatus(HttpStatus.CREATED)
  @Operation(summary = "Creates a descriptive metadata under AIP representation", description = "Create AIP descriptive metadata", requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = CreateDescriptiveMetadataRequest.class))), responses = {
  ...
  DescriptiveMetadata createRepresentationDescriptiveMetadata(@PathVariable(name = "id") String aipId,
    @PathVariable(name = "representation-id") String representationId, CreateDescriptiveMetadataRequest request);
  ...
  @RequestMapping(path = "/{id}/representation/{representation-id}/metadata/descriptive/{descriptive-metadata-id}/values", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
  @Operation(summary = "Get Supported metadata value", description = "Get AIP metadata value", responses = {
    @ApiResponse(responseCode = "200", description = "Supported Metadata", content = @Content(schema = @Schema(implementation = SupportedMetadataValue.class))),
    @ApiResponse(responseCode = "404", description = "Not found", content = @Content(schema = @Schema(implementation = ErrorResponseMessage.class)))})
  SupportedMetadataValue retrieveRepresentationSupportedMetadata(
    @Parameter(description = "The AIP identifier", required = true) @PathVariable(name = "id") String aipId,
    @Parameter(description = "The representation identifier", required = true) @PathVariable(name = "representation-id") String representationId,
    @Parameter(description = "The descriptive metadata identifier", required = true) @PathVariable(name = "descriptive-metadata-id") String metadataType,
    @Parameter(description = "The language to be used for internationalization", content = @Content(schema = @Schema(defaultValue = "en", implementation = String.class))) @RequestParam(name = "lang", defaultValue = "en", required = false) String localeString);
  ...
  @Operation(summary = "Gets a preview of descriptive metadata", description = "Get AIP descriptive metadata preview", responses = {
