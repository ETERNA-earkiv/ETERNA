...
public class RepresentationToolbarActions extends AbstractActionable<IndexedRepresentation> {
  ...
  private static final Set<RepresentationAction> POSSIBLE_ACTIONS_ON_SINGLE_REPRESENTATION = new HashSet<>(
    Arrays.asList(RepresentationAction.DOWNLOAD, RepresentationAction.CHANGE_TYPE, RepresentationAction.REMOVE,
      ...
      RepresentationAction.DOWNLOAD_METADATA, RepresentationAction.CREATE_DESCRIPTIVE_METADATA));
  ...
  public static RepresentationToolbarActions get() {
  ...
  public void act(Action<IndexedRepresentation> action, IndexedRepresentation representation,
    ...
    } else if (RepresentationAction.CREATE_DESCRIPTIVE_METADATA.equals(action)) {
      createDescriptiveMetadata(representation, callback);
    } else {
      unsupportedAction(action, callback);
    }
  }
  ...
  public void createDescriptiveMetadata(IndexedRepresentation representation,
    ...
    if (representation != null) {
      HistoryUtils.newHistory(BrowseTop.RESOLVER, CreateDescriptiveMetadata.RESOLVER.getHistoryToken(),
        RodaConstants.RODA_OBJECT_REPRESENTATION, representation.getAipId(), representation.getId());
    }
    callback.onSuccess(ActionImpact.NONE);
  }
  ...
  public ActionableBundle<IndexedRepresentation> createActionsBundle() {
    ...
    // MANAGEMENT
    ActionableGroup<IndexedRepresentation> managementGroup = new ActionableGroup<>(messages.manage(), "btn-edit");
    managementGroup.addButton(messages.newRepresentationButton(), RepresentationAction.NEW, ActionImpact.UPDATED,
      "btn-plus");
    managementGroup.addButton(messages.newDescriptiveMetadataTitle(), RepresentationAction.CREATE_DESCRIPTIVE_METADATA,
    ...
    representationActionableBundle.addGroup(downloadGroup).addGroup(managementGroup).addGroup(preservationGroup);
  ...
  public enum RepresentationAction implements Action<IndexedRepresentation> {
    ...
    CREATE_DESCRIPTIVE_METADATA(RodaConstants.PERMISSION_METHOD_UPDATE_REPRESENTATION_DESCRIPTIVE_METADATA_FILE);
