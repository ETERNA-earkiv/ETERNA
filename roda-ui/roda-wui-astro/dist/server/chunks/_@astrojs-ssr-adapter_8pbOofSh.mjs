import { a3 as ROUTE_TYPE_HEADER, y as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, A as AstroError, _ as ActionNotFoundError, aa as clientAddressSymbol, al as LocalsNotAnObject, am as FailedToFindPageMapSSR, an as REROUTABLE_STATUS_CODES, ae as responseSentSymbol, ao as nodeRequestAbortControllerCleanupSymbol } from './astro/server_BTiD7zzO.mjs';
import colors from 'piccolore';
import 'clsx';
import { D as DEFAULT_404_ROUTE, c as default404Instance, e as ensure404Route } from './astro-designed-error-pages_CX09QLHj.mjs';
import 'es-module-lexer';
import buffer from 'node:buffer';
import crypto from 'node:crypto';
import fs, { createReadStream, existsSync, readFileSync } from 'node:fs';
import { Http2ServerResponse } from 'node:http2';
import { f as fileExtension, j as joinPaths, s as slash, p as prependForwardSlash$1, c as removeTrailingForwardSlash, b as appendForwardSlash, d as isInternalPath, e as collapseDuplicateTrailingSlashes, h as hasFileExtension } from './path_1MJ8Acv8.mjs';
...
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_JZdU_wJ2.mjs';
