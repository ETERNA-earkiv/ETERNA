 ...
 */
public class PluginThatAlwaysFailsDuringExecuteMethod extends AbstractPlugin<AIP> {
  private static final Logger LOGGER = LoggerFactory.getLogger(PluginThatAlwaysFailsDuringExecuteMethod.class);
  ...
  public static String getStaticName() {
    return "Plugin that always fails during execute method";
  }
  ...
  public Plugin<AIP> cloneMe() {
    return new PluginThatAlwaysFailsDuringExecuteMethod();
  }
