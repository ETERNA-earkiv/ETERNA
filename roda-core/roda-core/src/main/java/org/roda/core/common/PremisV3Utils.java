...
public final class PremisV3Utils {
  ...
  public static Object binaryToGenericPremis(ContentPayload payload, boolean validate)
    throws GenericException, ValidationException {
    try (InputStream inputStream = payload.createInputStream()) {
      return binaryToGenericPremis(inputStream, validate);
    } catch (IOException e) {
      throw new GenericException("Error loading premis file", e);
    }
  }

  public static Object binaryToGenericPremis(InputStream binaryInputStream, boolean validate)
    throws ValidationException, GenericException {
    JAXBContext jaxbContext;
    ...
    try {
      ...
      return jaxbUnmarshaller.unmarshal(xmlSource);
      ...
      if (validate && validationCollector.hasEvents()) {
        ...
        throw new GenericException("Failed to load PREMIS: " + e.getMessage(), e);
      }
    }
  }
  ...
  public static void updateCreatingApplicationTechnicalMetadata(ModelService model, String aipId,
    ...
    try {
      ...
      ContentPayload premisFilePayload = fileToBinary(premisFile, TechnicalMetadata.class,
        TechnicalMetadataElement.class, TechnicalMetadataField.class);
