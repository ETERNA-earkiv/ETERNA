...
public class InstanceIdentifierDIPPlugin extends AbstractPlugin<Void> {
  ...
  public static String getStaticName() {
    return "DIP-instansidentifierare";
  }
  ...
  private void modifyInstanceId(ModelService model, IndexService index, Job cachedJob, Report pluginReport,
    ...
    if (countFail > 0) {
      ...
      details.append("Uppdaterade instansidentifieraren på ").append(countSuccess).append(" DIP:er och misslyckades med att uppdatera ")
      ...
      details.append("Uppdaterade instansidentifieraren på ").append(countSuccess).append(" DIP:er");
    }
