...
public class RepresentationPreservationMetadataIterable implements CloseableIterable<Resource> {
  private static final Logger LOGGER = LoggerFactory.getLogger(RepresentationPreservationMetadataIterable.class);

  private final CloseableIterable<Resource> aipResourcesSub;
  private final Iterator<Resource> aipIteratorSub;
  private final StorageService storage;

  public RepresentationPreservationMetadataIterable(StorageService storage, CloseableIterable<Resource> aipResourcesSub,
