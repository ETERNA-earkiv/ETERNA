...
public class Field {
  ...
  public Field(Map<String, Object> attributes) {
   ...
   * @return
   */
  public Field setIndexed(Optional<Boolean> indexed) {
   ...
   * @return
   */
  public Field setStored(Optional<Boolean> stored) {
    this.stored = stored;
    return this;
  }
   ...
   * @return
   */
  public Field setStored(Boolean stored) {
  ...
  public Field setDocValues(Optional<Boolean> docValues) {
   ...
   * @return
   */
  public Field setDocValues(Boolean docValues) {
  ...
  public Field setMultiValued(Optional<Boolean> multiValued) {
   ...
   * @return
   */
  public Field setMultiValued(Boolean multivalued) {
  ...
  public Field setRequired(Optional<Boolean> required) {
  ...
  public Field setDefaultValue(Optional<String> defaultValue) {
  ...
  public Update buildCreate() {
    return new AddField(getFieldAttributes());
  }
  ...
  public boolean isEquivalentTo(Field other) {
