...
public class HttpGenericNotification extends AbstractJobNotification implements GenericJobNotification {
  public HttpGenericNotification(String to) {
    super(to);
  }

  public HttpGenericNotification(String to, boolean whenFailed) {
    super(to, whenFailed);
  }
